...
Faculty::Faculty(int id, const string& fName, const string& lName, const string& dept, const string& addr,const   string& city, const string& state, const string& zip, const string& email, const string& phone)
...
void Faculty::setFacultyId(int id) { facultyId = id; }
